...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<BlocOrderCard, StateBlocOrderCard>(
                  ...
                  child: Row(
                    children: [
                      ...
                      MainButton(
                        ...
                        onTap: () {
                          context.read<BlocOrderCard>().add(EventResumeOrder());
                          ...
                          AppRouter.push(
                            ...
                            BlocProvider<BlocOrderFinish>(
                              ...
                              child: OrderFinish(
                                orderData: state.order,
                                isScan:
                                    widget.order.points!.first.id == point!.id,
                                // isScan: ,
                              ),
                            ),
                          ).then((value) {
