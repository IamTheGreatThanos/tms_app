...
void showCodeBottomDialog(BuildContext context, SignUpVModel vModel) {
  showAppBottomSheet(context,
      ...
      child: _BuildSmsCodeField(vmodel: vModel,));
}
                ...
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        S.of(context).code_send_to(widget.vmodel.phone.controller.text),
                      ...
                      Padding(
                        ...
                        child: PinCodeTextField(
                          ...
                          pinTheme: PinTheme(
                            ...
                            fieldHeight: 50,
                            fieldWidth: 50,
                            activeColor: ColorPalette.fieldGrey,
                            activeFillColor: ColorPalette.fieldGrey,
                            disabledColor: ColorPalette.fieldGrey,
                            errorBorderColor: ColorPalette.errorRed,
                            inactiveColor: ColorPalette.fieldGrey,
                            inactiveFillColor: ColorPalette.fieldGrey,
                            selectedColor: ColorPalette.fieldGrey,
                            selectedFillColor: ColorPalette.fieldGrey,
                          ),
                          onChanged: (value) {
                            if(value.length == 5) {
                              Navigator.of(context, rootNavigator: true).pop();
                              showCreatePasswordBottomDialog(
                                  context, widget.vmodel);
                            }
                          },
                          appContext: context,
                        ),
