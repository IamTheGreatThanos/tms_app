              ...
              children: <Widget>[
                ...
                ControlButton(
                    onPressed: () async {
                      ...
                      final placemark =
                          mapObjects.firstWhere((el) => el.mapId == placemarkId)
                              as Placemark;
              ...
              children: <Widget>[
                ...
                ControlButton(
                    onPressed: () async {
                      ...
                      setState(() {
                        mapObjects[
                                mapObjects.indexOf(placemarkWithDynamicIcon)] =
                            placemarkWithDynamicIcon.copyWith(
                                point: Point(
                                    latitude: placemarkWithDynamicIcon
                                            .point.latitude +
                                        1,
                                    longitude: placemarkWithDynamicIcon
                                            .point.longitude +
                                        1));
                      });
                    },
              ...
              children: <Widget>[
                ...
                ControlButton(
                    onPressed: () async {
                      ...
                      final placemarkWithCompositeIcon = mapObjects.firstWhere(
                              (el) => el.mapId == placemarkWithCompositeIconId)
                          as Placemark;
