...
class _ScheduleScreenState extends State<ScheduleScreen> {
  ...
  List <String> _calendarHeader=['1','2','3','4','5','6','7'];
  List <String> _calendarHeaderDate=['1','2','3','4','5','6','7'];
                ...
                children: <Widget>[
                    ...
                    child: Row(
                      children: [
                        ...
                        Text("${_headerTextYear}",
                            textAlign: TextAlign.center,
                            style: ProjectTextStyles.ui_20Medium.copyWith(color: ColorPalette.gray)),
                      ],
                    ),
                  ),
                  SizedBox(height: 15,),
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Text(_calendarHeader[i],
                            textAlign: TextAlign.center,
                            style: ProjectTextStyles.ui_12Medium.copyWith(color: ColorPalette.gray)),
                      ),
                    ],
                  ),
                  Row(
                    children: <Widget>[
                      for(int i=0;i<7;i++)
                        InkWell(
                          onTap: (){calendarController.displayDate= selectedDate.add(Duration(days:-currentDate+i+1 )); setState(() {
                  ...
                  Row(
                    children: <Widget>[
                      for(int i=0;i<7;i++)
                        if(i+1==currentDate)
                          Container(width: cellWidth,height: 5, child: icon1)
                        else
                          Container(width:  cellWidth,height: 10,
                  ...
                  Expanded(
                      child: SfCalendar(
                        ...
                        onViewChanged: (ViewChangedDetails viewChangedDetails) {
                          ...
                          if (calendarController.view == CalendarView.week || true) {
                            ...
                            currentDate = viewChangedDetails.visibleDates[0].weekday;
                            ...
                            for(int i=0;i< 7;i++) {
                              _calendarHeader[i] = DateFormat('EEE')
                                  ...
                                  .add(Duration(days:i-viewChangedDetails.visibleDates[0].weekday+1 )))
                                  .toString();
                            }
                            for(int i=0;i< 7;i++) {
